!function (e, t, n, s) {
    ...
    Foundation.libs.reveal = {name: "reveal", version: "5.2.0", locked: !1, settings: {animation: "fadeAndPop", animation_speed: 250, close_on_background_click: !0, close_on_esc: !0, dismiss_modal_class: "close-reveal-modal", bg_class: "reveal-modal-bg", open: function () {
        ...
        }), t(n).on("touchend.fndtn.reveal click.fndtn.reveal", this.close_targets(), function (n) {
            if (n.preventDefault(), !e.locked) {
        ...
        if (!i.hasClass("open")) {
            ...
            if ("undefined" == typeof i.data("css-top") && i.data("css-top", parseInt(i.css("top"), 10)).data("offset", this.cache_offset(i)), this.key_up_on(i), i.trigger("open"), o.length < 1 && this.toggle_bg(i), "string" == typeof n && (n = {url: n}), "undefined" != typeof n && n.url) {
                ...
                e.extend(n, {success: function (t, n, d) {
                    e.isFunction(r) && r(t, n, d), i.html(t), s.S(i).foundation("section", "reflow"), o.length > 0 && s.hide(o, a.css.close), s.show(i, a.css.open)
                }}), e.ajax(n)
            } else o.length > 0 && this.hide(o, a.css.close), this.show(i, a.css.open)
        }
    }, close: function (e) {
        ...
        0 === this.S("." + this.settings.bg_class).length && (this.settings.bg = e("<div />", {"class": this.settings.bg_class}).appendTo("body").hide()), this.settings.bg.filter(":visible").length > 0 ? this.hide(this.settings.bg) : this.show(this.settings.bg)
    }, show: function (n, s) {
        if (s) {
            var a = n.data(this.attr_name(!0) + "-init");
            if (0 === n.parent("body").length) {
                var o = n.wrap('<div style="display: none;" />').parent(), r = this.settings.rootElement || "body";
            ...
            if (d.animate || (this.locked = !1), d.pop) {
                ...
                var c = {top: e(t).scrollTop() + n.data("css-top") + "px", opacity: 1};
                return setTimeout(function () {
                    return n.css(s).animate(c, a.animation_speed, "linear", function () {
        ...
        if (s) {
            var a = n.data(this.attr_name(!0) + "-init"), o = i(a.animation);
            if (o.animate || (this.locked = !1), o.pop) {
                var r = {top: -e(t).scrollTop() - n.data("offset") + "px", opacity: 0};
                return setTimeout(function () {
