!function (t, e, n, i) {
    ...
    var s = function (e) {
        var n = e.length;
        for (t("head"); n--;)0 === t("head").has("." + e[n]).length && t("head").append('<meta class="' + e[n] + '" />')
    };
    ...
    e.matchMedia = e.matchMedia || function (t) {
        ...
        function t() {
            n && (s(t), r && jQuery.fx.tick())
        }

        for (var n, i = 0, a = ["webkit", "moz"], s = e.requestAnimationFrame, o = e.cancelAnimationFrame, r = "undefined" != typeof jQuery.fx; i < a.length && !s; i++)s = e[a[i] + "RequestAnimationFrame"], o = o || e[a[i] + "CancelAnimationFrame"] || e[a[i] + "CancelRequestAnimationFrame"];
        s ? (e.requestAnimationFrame = s, e.cancelAnimationFrame = o, r && (jQuery.fx.timer = function (e) {
        ...
        return this.libs.hasOwnProperty(e) ? (this.patch(this.libs[e]), n && n.hasOwnProperty(e) ? ("undefined" != typeof this.libs[e].settings ? t.extend(!0, this.libs[e].settings, n[e]) : "undefined" != typeof this.libs[e].defaults && t.extend(!0, this.libs[e].defaults, n[e]), this.libs[e].init.apply(this.libs[e], [this.scope, n[e]])) : (n = n instanceof Array ? n : Array(n), this.libs[e].init.apply(this.libs[e], n))) : function () {
        }
    }, patch: function (t) {
        ...
        for (o = (l || ":").split(";"), a = o.length; a--;)s = o[a].split(":"), /true/i.test(s[1]) && (s[1] = !0), /false/i.test(s[1]) && (s[1] = !1), n(s[1]) && (s[1] = -1 === s[1].indexOf(".") ? parseInt(s[1], 10) : parseFloat(s[1], 10)), 2 === s.length && s[0].length > 0 && (r[i(s[0])] = i(s[1]));
        return r
