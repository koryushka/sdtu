...
!function (t, e) {
    ...
    $(".fancybox-button").fancybox({prevEffect: "none", nextEffect: "none", closeBtn: !1, helpers: {title: {type: "inside"}, buttons: {}}})
    ...
    }, openEffect: "elastic", helpers: {title: {type: "over"}, buttons: {}, mouseWheel: !0, thumbs: {width: 50, height: 50}, overlay: {showEarly: !1, css: {background: "rgba(58, 42, 45, 0.95)"}}}, afterLoad: function () {
