...
function dynamicBG() {
    ...
    15 > e ? $("#container").addClass("bodystyle") : e >= 15 && 30 > e ? $("#container").addClass("bodystyle") : e >= 30 && 45 > e ? $("#container").addClass("bodystyle") : e >= 45 && 59 >= e && $("#container").addClass("bodystyle")
}
!function (t, e) {
    ...
    function H(t, e, i) {
        ...
        if (!ae.isEmptyObject(h)) {
            ...
            for (n in h)o = N(f ? m[n] : 0, n, u), n in m || (m[n] = o.start, f && (o.end = o.start, o.start = "width" === n || "height" === n ? 1 : 0))
        }
    }
    ...
    function M(t, e, i) {
        var n, s, a = 0, o = bi.length, r = ae.Deferred().always(function () {
            ...
            if (s)return!1;
            for (var e = fi || D(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, a = 1 - n, o = 0, l = c.tweens.length; l > o; o++)c.tweens[o].run(a);
            return r.notifyWith(t, [c, a, i]), 1 > a && l ? i : (r.resolveWith(t, [c]), !1)
        }, c = r.promise({elem: t, props: ae.extend({}, e), opts: ae.extend(!0, {specialEasing: {}}, i), originalProperties: e, originalOptions: i, startTime: fi || D(), duration: i.duration, tweens: [], createTween: function (e, i) {
        ...
        return ae.map(d, N, c), ae.isFunction(c.opts.start) && c.opts.start.call(t, c), ae.fx.timer(ae.extend(l, {elem: t, anim: c, queue: c.opts.queue})), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always)
    }
    ...
    var de = function (t) {
        ...
        var w, k, C, j, S, T, E, P, F, A, q, D, L, N, H, O, M, $ = "sizzle" + -new Date, R = t.document, W = 0, I = 0, z = i(), B = i(), V = i(), U = function (t, e) {
            return t === e && (F = !0), 0
        ...
        k = e.support = {}, S = e.isXML = function (t) {
            ...
            return i !== q && 9 === i.nodeType && i.documentElement ? (q = i, D = i.documentElement, L = !S(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function () {
                A()
            ...
            }, H = [], N = [], (k.qsa = ve.test(i.querySelectorAll)) && (s(function (t) {
                t.innerHTML = "<select t=''><option selected=''></option></select>", t.querySelectorAll("[t^='']").length && N.push("[*^$]=" + ne + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || N.push("\\[" + ne + "*(?:value|" + ie + ")"), t.querySelectorAll(":checked").length || N.push(":checked")
            }), s(function (t) {
            ...
            })), (k.matchesSelector = ve.test(O = D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && s(function (t) {
                k.disconnectedMatch = O.call(t, "div"), O.call(t, "[s!='']:x"), H.push("!=", re)
            }), N = N.length && new RegExp(N.join("|")), H = H.length && new RegExp(H.join("|")), e = ve.test(D.compareDocumentPosition), M = e || ve.test(D.contains) ? function (t, e) {
            ...
            if ((t.ownerDocument || t) !== q && A(t), i = i.replace(ue, "='$1']"), !(!k.matchesSelector || !L || H && H.test(i) || N && N.test(i)))try {
                var n = O.call(t, i);
    ...
    var qe = /^(?:input|select|textarea)$/i, De = /^key/, Le = /^(?:mouse|contextmenu)|click/, Ne = /^(?:focusinfocus|focusoutblur)$/, He = /^([^.]*)(?:\.(.+)|)$/;
    ae.event = {global: {}, add: function (t, e, i, n, s) {
        ...
        if (r = d = n = n || me, 3 !== n.nodeType && 8 !== n.nodeType && !Ne.test(p + ae.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, e = e[ae.expando] ? e : new ae.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ae.makeArray(i, [e]), c = ae.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
            if (!s && !c.noBubble && !ae.isWindow(n)) {
                for (l = c.delegateType || p, Ne.test(l + p) || (r = r.parentNode); r; r = r.parentNode)h.push(r), d = r;
        ...
        for (o || (this.fixHooks[s] = o = Le.test(s) ? this.mouseHooks : De.test(s) ? this.keyHooks : {}), n = o.props ? this.props.concat(o.props) : this.props, t = new ae.Event(a), e = n.length; e--;)i = n[e], t[i] = a[i];
    ...
    ae.parseJSON = function (e) {
        ...
        return s && !ae.trim(s.replace(Di, function (t, e, s, a) {
    ...
    var Li, Ni, Hi = /#.*$/, Oi = /([?&])_=[^&]*/, Mi = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, $i = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ri = /^(?:GET|HEAD)$/, Wi = /^\/\//, Ii = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, zi = {}, Bi = {}, Vi = "*/".concat("*");
    try {
        Ni = location.href
    } catch (Ui) {
        Ni = me.createElement("a"), Ni.href = "", Ni = Ni.href
    }
    Li = Ii.exec(Ni.toLowerCase()) || [], ae.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Ni, type: "GET", isLocal: $i.test(Li[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Vi, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": !0, "text json": ae.parseJSON, "text xml": ae.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (t, e) {
        ...
        if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, u.url = ((t || u.url || Ni) + "").replace(Hi, "").replace(Wi, Li[1] + "//"), u.type = e.method || e.type || u.method || u.type, u.dataTypes = ae.trim(u.dataType || "*").toLowerCase().match(_e) || [""], null == u.crossDomain && (n = Ii.exec(u.url.toLowerCase()), u.crossDomain = !(!n || n[1] === Li[1] && n[2] === Li[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Li[3] || ("http:" === Li[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = ae.param(u.data, u.traditional)), R(zi, u, e, x), 2 === b)return x;
    ...
    i.extend(r, {version: "2.1.5", defaults: {padding: 15, margin: 20, width: 800, height: 600, minWidth: 100, minHeight: 100, maxWidth: 9999, maxHeight: 9999, pixelRatio: 1, autoSize: !0, autoHeight: !1, autoWidth: !1, autoResize: !0, autoCenter: !d, fitToView: !0, aspectRatio: !1, topRatio: .5, leftRatio: .5, scrolling: "auto", wrapCSS: "", arrows: !0, closeBtn: !0, closeClick: !1, nextClick: !1, mouseWheel: !0, autoPlay: !1, playSpeed: 3e3, preload: 3, modal: !1, loop: !0, ajax: {dataType: "html", headers: {"X-fancyBox": !0}}, iframe: {scrolling: "auto", preload: !0}, swf: {wmode: "transparent", allowfullscreen: "true", allowscriptaccess: "always"}, keys: {next: {13: "left", 34: "up", 39: "left", 40: "up"}, prev: {8: "right", 33: "down", 37: "right", 38: "down"}, close: [27], play: [32], toggle: [70]}, direction: {next: "left", prev: "right"}, scrollOutside: !0, index: 0, type: null, href: null, content: null, title: null, tpl: {wrap: '<div class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div class="fancybox-outer"><div class="fancybox-inner"></div></div></div></div>', image: '<img class="fancybox-image" src="{href}" alt="" />', iframe: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' + (l ? ' allowtransparency="true"' : "") + "></iframe>", error: '<p class="fancybox-error">The requested content cannot be loaded.<br/>Please try again later.</p>', closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a>', next: '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>', prev: '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'}, openEffect: "fade", openSpeed: 250, openEasing: "swing", openOpacity: !0, openMethod: "zoomIn", closeEffect: "fade", closeSpeed: 250, closeEasing: "swing", closeOpacity: !0, closeMethod: "zoomOut", nextEffect: "elastic", nextSpeed: 250, nextEasing: "swing", nextMethod: "changeIn", prevEffect: "elastic", prevSpeed: 250, prevEasing: "swing", prevMethod: "changeOut", helpers: {overlay: !0, title: !0}, onCancel: i.noop, beforeLoad: i.noop, afterLoad: i.noop, beforeShow: i.noop, afterShow: i.noop, beforeChange: i.noop, beforeClose: i.noop, afterClose: i.noop}, group: {}, opts: {}, previous: null, coming: null, current: null, isActive: !1, isOpen: !1, isOpened: !1, wrap: null, skin: null, outer: null, inner: null, player: {timer: null, isActive: !1}, ajaxLoad: null, imgPreload: null, transitions: {}, helpers: {}, open: function (t, e) {
        ...
        var t, e, n, s, a, o, l, c, d, u, h, f, v, y, b, _ = r.getViewport(), x = 0, w = !1, k = !1, C = r.wrap, j = r.skin, S = r.inner, T = r.current, E = T.width, P = T.height, F = T.minWidth, A = T.minHeight, q = T.maxWidth, D = T.maxHeight, L = T.scrolling, N = T.scrollOutside ? T.scrollbarWidth : 0, H = T.margin, O = m(H[1] + H[3]), M = m(H[0] + H[2]);
        if (C.add(j).add(S).width("auto").height("auto").removeClass("fancybox-tmp"), t = m(j.outerWidth(!0) - j.width()), e = m(j.outerHeight(!0) - j.height()), n = O + t, s = M + e, a = p(E) ? (_.w - n) * m(E) / 100 : E, o = p(P) ? (_.h - s) * m(P) / 100 : P, "iframe" === T.type) {
            if (y = T.content, T.autoHeight && 1 === y.data("ready"))try {
                y[0].contentWindow.document.location && (S.width(a).height(9999), b = y.contents().find("body"), N && b.css("overflow-x", "hidden"), o = b.outerHeight(!0))
            } catch ($) {
            }
        ...
        if (E = m(a), P = m(o), d = a / o, F = m(p(F) ? m(F, "w") - n : F), q = m(p(q) ? m(q, "w") - n : q), A = m(p(A) ? m(A, "h") - s : A), D = m(p(D) ? m(D, "h") - s : D), l = q, c = D, T.fitToView && (q = Math.min(_.w - n, q), D = Math.min(_.h - s, D)), f = _.w - O, v = _.h - M, T.aspectRatio ? (E > q && (E = q, P = m(E / d)), P > D && (P = D, E = m(P * d)), F > E && (E = F, P = m(E / d)), A > P && (P = A, E = m(P * d))) : (E = Math.max(F, Math.min(E, q)), T.autoHeight && "iframe" !== T.type && (S.width(E), P = S.height()), P = Math.max(A, Math.min(P, D))), T.fitToView)if (S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(), T.aspectRatio)for (; (u > f || h > v) && E > F && P > A && !(x++ > 19);)P = Math.max(A, Math.min(D, P - 10)), E = m(P * d), F > E && (E = F, P = m(E / d)), E > q && (E = q, P = m(E / d)), S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(); else E = Math.max(F, Math.min(E, E - (u - f))), P = Math.max(A, Math.min(P, P - (h - v)));
        N && "auto" === L && o > P && f > E + t + N && (E += N), S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(), w = (u > f || h > v) && E > F && P > A, k = T.aspectRatio ? l > E && c > P && a > E && o > P : (l > E || c > P) && (a > E || o > P), i.extend(T, {dim: {width: g(u), height: g(h)}, origWidth: a, origHeight: o, canShrink: w, canExpand: k, wPadding: t, hPadding: e, wrapSpace: h - j.outerHeight(!0), skinSpace: j.height() - P}), !y && T.autoHeight && P > A && D > P && !k && S.height("auto")
