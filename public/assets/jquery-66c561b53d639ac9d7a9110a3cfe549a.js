!function (e, t) {
    ...
    ot.fn.extend({attr: function (e, t) {
        ...
        return ot.nodeName(e, "input") ? (e.defaultValue = t, void 0) : Cn && Cn.set(e, t, n)
    ...
    ot.offset = {setOffset: function (e, t, n) {
        ...
        if (o)return t = o.documentElement, ot.contains(t, i) ? (typeof i.getBoundingClientRect !== Nt && (r = i.getBoundingClientRect()), n = V(o), {top: r.top + (n.pageYOffset || t.scrollTop) - (t.clientTop || 0), left: r.left + (n.pageXOffset || t.scrollLeft) - (t.clientLeft || 0)}) : r
    }, position: function () {
        if (this[0]) {
