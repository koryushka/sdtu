!function (t) {
    var i = t.fancybox;
    i.helpers.thumbs = {defaults: {width: 50, height: 50, position: "bottom", source: function (i) {
        var h;
        ...
        return i.group.length < 2 ? (i.helpers.thumbs = !1, void 0) : (i.margin["top" === t.position ? 0 : 2] += t.height + 15, void 0)
