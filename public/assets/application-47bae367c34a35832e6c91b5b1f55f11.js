...
!function (t, e) {
    ...
    function H(t, e, i) {
        ...
        if (!ae.isEmptyObject(h)) {
            ...
            for (n in h)o = L(f ? m[n] : 0, n, u), n in m || (m[n] = o.start, f && (o.end = o.start, o.start = "width" === n || "height" === n ? 1 : 0))
        }
    }
    ...
    function M(t, e, i) {
        var n, s, a = 0, o = bi.length, r = ae.Deferred().always(function () {
            ...
            if (s)return!1;
            for (var e = fi || q(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, a = 1 - n, o = 0, l = c.tweens.length; l > o; o++)c.tweens[o].run(a);
            return r.notifyWith(t, [c, a, i]), 1 > a && l ? i : (r.resolveWith(t, [c]), !1)
        }, c = r.promise({elem: t, props: ae.extend({}, e), opts: ae.extend(!0, {specialEasing: {}}, i), originalProperties: e, originalOptions: i, startTime: fi || q(), duration: i.duration, tweens: [], createTween: function (e, i) {
        ...
        return ae.map(d, L, c), ae.isFunction(c.opts.start) && c.opts.start.call(t, c), ae.fx.timer(ae.extend(l, {elem: t, anim: c, queue: c.opts.queue})), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always)
    }
    ...
    function B(t, e, i, n) {
        ...
        if (ae.isArray(e))ae.each(e, function (e, s) {
            i || Zi.test(t) ? n(t, s) : B(t + "[" + ("object" == typeof s ? e : "") + "]", s, i, n)
    ...
    var Z = [], Q = Z.slice, K = Z.concat, G = Z.push, J = Z.indexOf, Y = {}, te = Y.toString, ee = Y.hasOwnProperty, ie = "".trim, ne = {}, se = "1.11.0", ae = function (t, e) {
    ...
    }, push: G, sort: Z.sort, splice: Z.splice}, ae.extend = ae.fn.extend = function () {
    ...
    var de = function (t) {
        function e(t, e, i, n) {
            ...
            if ((e ? e.ownerDocument || e : R) !== D && A(e), e = e || D, i = i || [], !t || "string" != typeof t)return i;
        ...
        function b(t, i) {
            var s = i.length > 0, a = t.length > 0, o = function (n, o, r, l, c) {
                ...
                for (c && (E = o !== D && o); f !== x && null != (d = b[f]); f++) {
                    if (a && d) {
        ...
        function x(t, e, i, n) {
            var s, a, o, r, l, c = h(t);
            if (!n && 1 === c.length) {
                if (a = c[0] = c[0].slice(0), a.length > 2 && "ID" === (o = a[0]).type && k.getById && 9 === e.nodeType && N && C.relative[a[1].type]) {
            ...
            return T(t, c)(n, e, !N, i, be.test(t) && d(e.parentNode) || e), i
        }

        var w, k, C, j, S, T, E, P, F, A, D, q, N, L, H, O, M, $ = "sizzle" + -new Date, R = t.document, W = 0, I = 0, z = i(), B = i(), V = i(), U = function (t, e) {
            return t === e && (F = !0), 0
        }, X = "undefined", Z = 1 << 31, Q = {}.hasOwnProperty, K = [], G = K.pop, J = K.push, Y = K.push, te = K.slice, ee = K.indexOf || function (t) {
        ...
        k = e.support = {}, S = e.isXML = function (t) {
            ...
            return i !== D && 9 === i.nodeType && i.documentElement ? (D = i, q = i.documentElement, N = !S(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function () {
                A()
                ...
                return q.appendChild(t).id = $, !i.getElementsByName || !i.getElementsByName($).length
            ...
            }, H = [], L = [], (k.qsa = ve.test(i.querySelectorAll)) && (s(function (t) {
            ...
            })), (k.matchesSelector = ve.test(O = q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && s(function (t) {
                k.disconnectedMatch = O.call(t, "div"), O.call(t, "[s!='']:x"), H.push("!=", re)
            }), L = L.length && new RegExp(L.join("|")), H = H.length && new RegExp(H.join("|")), e = ve.test(q.compareDocumentPosition), M = e || ve.test(q.contains) ? function (t, e) {
            ...
            if ((t.ownerDocument || t) !== D && A(t), i = i.replace(ue, "='$1']"), !(!k.matchesSelector || !N || H && H.test(i) || L && L.test(i)))try {
                var n = O.call(t, i);
            ...
            var i = C.attrHandle[e.toLowerCase()], n = i && Q.call(C.attrHandle, e.toLowerCase()) ? i(t, e, !N) : void 0;
    ...
    var De = /^(?:input|select|textarea)$/i, qe = /^key/, Ne = /^(?:mouse|contextmenu)|click/, Le = /^(?:focusinfocus|focusoutblur)$/, He = /^([^.]*)(?:\.(.+)|)$/;
    ae.event = {global: {}, add: function (t, e, i, n, s) {
        ...
        if (r = d = n = n || me, 3 !== n.nodeType && 8 !== n.nodeType && !Le.test(p + ae.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, e = e[ae.expando] ? e : new ae.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ae.makeArray(i, [e]), c = ae.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
            if (!s && !c.noBubble && !ae.isWindow(n)) {
                for (l = c.delegateType || p, Le.test(l + p) || (r = r.parentNode); r; r = r.parentNode)h.push(r), d = r;
        ...
        for (o || (this.fixHooks[s] = o = Ne.test(s) ? this.mouseHooks : qe.test(s) ? this.keyHooks : {}), n = o.props ? this.props.concat(o.props) : this.props, t = new ae.Event(a), e = n.length; e--;)i = n[e], t[i] = a[i];
        ...
        return De.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (ae.event.add(this, "propertychange._change", function (t) {
            ...
            var e = t.target;
            De.test(e.nodeName) && !ae._data(e, "changeBubbles") && (ae.event.add(e, "change._change", function (t) {
        ...
        return ae.event.remove(this, "._change"), !De.test(this.nodeName)
    ...
    Ke.optgroup = Ke.option, Ke.tbody = Ke.tfoot = Ke.colgroup = Ke.caption = Ke.thead, Ke.th = Ke.td, ae.extend({clone: function (t, e, i) {
        ...
        for (r && h.removeChild(r), ne.appendChecked || ae.grep(g(p, "input"), v), f = 0; a = p[f++];)if ((!n || -1 === ae.inArray(a, n)) && (o = ae.contains(a.ownerDocument, a), r = g(h.appendChild(a), "script"), o && x(r), i))for (s = 0; a = r[s++];)Xe.test(a.type || "") && i.push(a);
        return r = null, h
        ...
        for (var i, n, s, a, o = 0, r = ae.expando, l = ae.cache, c = ne.deleteExpando, d = ae.event.special; null != (i = t[o]); o++)if ((e || ae.acceptData(i)) && (s = i[r], a = s && l[s])) {
            ...
            l[s] && (delete l[s], c ? delete i[r] : typeof i.removeAttribute !== Ce ? i.removeAttribute(r) : i[r] = null, Z.push(s))
        }
        ...
        if (c && (r = ae.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
            ...
            if (s)for (o = a[a.length - 1].ownerDocument, ae.map(a, _), l = 0; s > l; l++)n = a[l], Xe.test(n.type || "") && !ae._data(n, "globalEval") && ae.contains(o, n) && (n.src ? ae._evalUrl && ae._evalUrl(n.src) : ae.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Qe, "")));
            r = i = null
        }
        return this
    ...
    ae.extend({cssHooks: {opacity: {get: function (t, e) {
    ...
    }}), ae.Tween = D, D.prototype = {constructor: D, init: function (t, e, i, n, s, a) {
        ...
        return this.pos = e = this.options.duration ? ae.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : D.propHooks._default.set(this), this
    ...
    }), ae.each({slideDown: N("show"), slideUp: N("hide"), slideToggle: N("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (t, e) {
    ...
    ae.parseJSON = function (e) {
        ...
        return s && !ae.trim(s.replace(qi, function (t, e, s, a) {
    ...
    var Ni, Li, Hi = /#.*$/, Oi = /([?&])_=[^&]*/, Mi = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, $i = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ri = /^(?:GET|HEAD)$/, Wi = /^\/\//, Ii = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, zi = {}, Bi = {}, Vi = "*/".concat("*");
    try {
        Li = location.href
    } catch (Ui) {
        Li = me.createElement("a"), Li.href = "", Li = Li.href
    }
    Ni = Ii.exec(Li.toLowerCase()) || [], ae.extend({active: 0, lastModified: {}, etag: {}, ajaxSettings: {url: Li, type: "GET", isLocal: $i.test(Ni[1]), global: !0, processData: !0, async: !0, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: {"*": Vi, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript"}, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText", json: "responseJSON"}, converters: {"* text": String, "text html": !0, "text json": ae.parseJSON, "text xml": ae.parseXML}, flatOptions: {url: !0, context: !0}}, ajaxSetup: function (t, e) {
        ...
        if (f.promise(x).complete = m.add, x.success = x.done, x.error = x.fail, u.url = ((t || u.url || Li) + "").replace(Hi, "").replace(Wi, Ni[1] + "//"), u.type = e.method || e.type || u.method || u.type, u.dataTypes = ae.trim(u.dataType || "*").toLowerCase().match(_e) || [""], null == u.crossDomain && (n = Ii.exec(u.url.toLowerCase()), u.crossDomain = !(!n || n[1] === Ni[1] && n[2] === Ni[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Ni[3] || ("http:" === Ni[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = ae.param(u.data, u.traditional)), R(zi, u, e, x), 2 === b)return x;
        l = u.global, l && 0 === ae.active++ && ae.event.trigger("ajaxStart"), u.type = u.type.toUpperCase(), u.hasContent = !Ri.test(u.type), a = u.url, u.hasContent || (u.data && (a = u.url += (Di.test(a) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = Oi.test(a) ? a.replace(Oi, "$1_=" + Ai++) : a + (Di.test(a) ? "&" : "?") + "_=" + Ai++)), u.ifModified && (ae.lastModified[a] && x.setRequestHeader("If-Modified-Since", ae.lastModified[a]), ae.etag[a] && x.setRequestHeader("If-None-Match", ae.etag[a])), (u.data && u.hasContent && u.contentType !== !1 || e.contentType) && x.setRequestHeader("Content-Type", u.contentType), x.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + Vi + "; q=0.01" : "") : u.accepts["*"]);
    ...
    ae.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        return r || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = ae.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, r ? e[r] = e[r].replace(nn, "$1" + s) : e.jsonp !== !1 && (e.url += (Di.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function () {
    ...
    ae.offset = {setOffset: function (t, e, i) {
        ...
        if (a)return e = a.documentElement, ae.contains(e, s) ? (typeof s.getBoundingClientRect !== Ce && (n = s.getBoundingClientRect()), i = X(a), {top: n.top + (i.pageYOffset || e.scrollTop) - (e.clientTop || 0), left: n.left + (i.pageXOffset || e.scrollLeft) - (e.clientLeft || 0)}) : n
    }, position: function () {
        if (this[0]) {
    ...
    i.extend(r, {version: "2.1.5", defaults: {padding: 15, margin: 20, width: 800, height: 600, minWidth: 100, minHeight: 100, maxWidth: 9999, maxHeight: 9999, pixelRatio: 1, autoSize: !0, autoHeight: !1, autoWidth: !1, autoResize: !0, autoCenter: !d, fitToView: !0, aspectRatio: !1, topRatio: .5, leftRatio: .5, scrolling: "auto", wrapCSS: "", arrows: !0, closeBtn: !0, closeClick: !1, nextClick: !1, mouseWheel: !0, autoPlay: !1, playSpeed: 3e3, preload: 3, modal: !1, loop: !0, ajax: {dataType: "html", headers: {"X-fancyBox": !0}}, iframe: {scrolling: "auto", preload: !0}, swf: {wmode: "transparent", allowfullscreen: "true", allowscriptaccess: "always"}, keys: {next: {13: "left", 34: "up", 39: "left", 40: "up"}, prev: {8: "right", 33: "down", 37: "right", 38: "down"}, close: [27], play: [32], toggle: [70]}, direction: {next: "left", prev: "right"}, scrollOutside: !0, index: 0, type: null, href: null, content: null, title: null, tpl: {wrap: '<div class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div class="fancybox-outer"><div class="fancybox-inner"></div></div></div></div>', image: '<img class="fancybox-image" src="{href}" alt="" />', iframe: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' + (l ? ' allowtransparency="true"' : "") + "></iframe>", error: '<p class="fancybox-error">The requested content cannot be loaded.<br/>Please try again later.</p>', closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a>', next: '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>', prev: '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'}, openEffect: "fade", openSpeed: 250, openEasing: "swing", openOpacity: !0, openMethod: "zoomIn", closeEffect: "fade", closeSpeed: 250, closeEasing: "swing", closeOpacity: !0, closeMethod: "zoomOut", nextEffect: "elastic", nextSpeed: 250, nextEasing: "swing", nextMethod: "changeIn", prevEffect: "elastic", prevSpeed: 250, prevEasing: "swing", prevMethod: "changeOut", helpers: {overlay: !0, title: !0}, onCancel: i.noop, beforeLoad: i.noop, afterLoad: i.noop, beforeShow: i.noop, afterShow: i.noop, beforeChange: i.noop, beforeClose: i.noop, afterClose: i.noop}, group: {}, opts: {}, previous: null, coming: null, current: null, isActive: !1, isOpen: !1, isOpened: !1, wrap: null, skin: null, outer: null, inner: null, player: {timer: null, isActive: !1}, ajaxLoad: null, imgPreload: null, transitions: {}, helpers: {}, open: function (t, e) {
        ...
        var t, e, n, s, a, o, l, c, d, u, h, f, v, y, b, _ = r.getViewport(), x = 0, w = !1, k = !1, C = r.wrap, j = r.skin, S = r.inner, T = r.current, E = T.width, P = T.height, F = T.minWidth, A = T.minHeight, D = T.maxWidth, q = T.maxHeight, N = T.scrolling, L = T.scrollOutside ? T.scrollbarWidth : 0, H = T.margin, O = m(H[1] + H[3]), M = m(H[0] + H[2]);
        if (C.add(j).add(S).width("auto").height("auto").removeClass("fancybox-tmp"), t = m(j.outerWidth(!0) - j.width()), e = m(j.outerHeight(!0) - j.height()), n = O + t, s = M + e, a = p(E) ? (_.w - n) * m(E) / 100 : E, o = p(P) ? (_.h - s) * m(P) / 100 : P, "iframe" === T.type) {
            if (y = T.content, T.autoHeight && 1 === y.data("ready"))try {
                y[0].contentWindow.document.location && (S.width(a).height(9999), b = y.contents().find("body"), L && b.css("overflow-x", "hidden"), o = b.outerHeight(!0))
            } catch ($) {
            }
        ...
        if (E = m(a), P = m(o), d = a / o, F = m(p(F) ? m(F, "w") - n : F), D = m(p(D) ? m(D, "w") - n : D), A = m(p(A) ? m(A, "h") - s : A), q = m(p(q) ? m(q, "h") - s : q), l = D, c = q, T.fitToView && (D = Math.min(_.w - n, D), q = Math.min(_.h - s, q)), f = _.w - O, v = _.h - M, T.aspectRatio ? (E > D && (E = D, P = m(E / d)), P > q && (P = q, E = m(P * d)), F > E && (E = F, P = m(E / d)), A > P && (P = A, E = m(P * d))) : (E = Math.max(F, Math.min(E, D)), T.autoHeight && "iframe" !== T.type && (S.width(E), P = S.height()), P = Math.max(A, Math.min(P, q))), T.fitToView)if (S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(), T.aspectRatio)for (; (u > f || h > v) && E > F && P > A && !(x++ > 19);)P = Math.max(A, Math.min(q, P - 10)), E = m(P * d), F > E && (E = F, P = m(E / d)), E > D && (E = D, P = m(E / d)), S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(); else E = Math.max(F, Math.min(E, E - (u - f))), P = Math.max(A, Math.min(P, P - (h - v)));
        L && "auto" === N && o > P && f > E + t + L && (E += L), S.width(E).height(P), C.width(E + t), u = C.width(), h = C.height(), w = (u > f || h > v) && E > F && P > A, k = T.aspectRatio ? l > E && c > P && a > E && o > P : (l > E || c > P) && (a > E || o > P), i.extend(T, {dim: {width: g(u), height: g(h)}, origWidth: a, origHeight: o, canShrink: w, canExpand: k, wPadding: t, hPadding: e, wrapSpace: h - j.outerHeight(!0), skinSpace: j.height() - P}), !y && T.autoHeight && P > A && q > P && !k && S.height("auto")
    ...
    e.matchMedia = e.matchMedia || function (t) {
        ...
        for (o = (c || ":").split(";"), s = o.length; s--;)a = o[s].split(":"), /true/i.test(a[1]) && (a[1] = !0), /false/i.test(a[1]) && (a[1] = !1), i(a[1]) && (a[1] = -1 === a[1].indexOf(".") ? parseInt(a[1], 10) : parseFloat(a[1], 10)), 2 === a.length && a[0].length > 0 && (r[n(a[0])] = n(a[1]));
        return r
    ...
    Foundation.libs.abide = {name: "abide", version: "5.2.0", settings: {live_validate: !0, focus_on_invalid: !0, error_labels: !0, timeout: 1e3, patterns: {alpha: /^[a-zA-Z]+$/, alpha_numeric: /^[a-zA-Z0-9]+$/, integer: /^\d+$/, number: /-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?/, card: /^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/, cvv: /^([0-9]){3,4}$/, email: /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/, url: /(https?|ftp|file|ssh):\/\/(((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?/, domain: /^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$/, datetime: /([0-2][0-9]{3})\-([0-1][0-9])\-([0-3][0-9])T([0-5][0-9])\:([0-5][0-9])\:([0-5][0-9])(Z|([\-\+]([0-1][0-9])\:00))/, date: /(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))/, time: /(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}/, dateISO: /\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}/, month_day_year: /(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.](19|20)\d\d/, color: /^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/}}, timer: null, init: function (t, e, i) {
        ...
        this.invalid_attr = this.add_namespace("data-invalid"), n.off(".abide").on("submit.fndtn.abide validate.fndtn.abide",function (t) {
            ...
            var n = t(this).closest("form").data(i.attr_name(!0) + "-init");
        ...
        for (var i = e.length, n = []; i--;) {
            ...
            s = l.is("label") ? l.parent() : l, d && o ? n.push(this.valid_radio(a, o)) : u && o ? n.push(this.valid_checkbox(a, o)) : c && o ? n.push(this.valid_equal(a, o, s)) : e[i][1].test(r) && p || !o && a.value.length < 1 || t(a).attr("disabled") ? (this.S(a).removeAttr(this.invalid_attr), s.removeClass("error"), h.length > 0 && this.settings.error_labels && h.removeClass("error"), n.push(!0), t(a).triggerHandler("valid")) : (this.S(a).attr(this.invalid_attr, ""), s.addClass("error"), h.length > 0 && this.settings.error_labels && h.addClass("error"), n.push(!1), t(a).triggerHandler("invalid"))
        }
        return n
    ...
    Foundation.libs.accordion = {name: "accordion", version: "5.2.0", settings: {active_class: "active", toggleable: !0}, init: function (t, e, i) {
        ...
        i(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] dd > a", function (n) {
            ...
            if (n.preventDefault(), i(this).closest("dl").is(s)) {
                if (c[0] == a[0] && l.toggleable)return d.toggleClass(l.active_class, !1), a.toggleClass(l.active_class, !1);
    ...
    Foundation.libs.clearing = {name: "clearing", version: "5.2.0", settings: {templates: {viewing: '<a href="#" class="clearing-close">&times;</a><div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt="" /><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div>'}, close_selectors: ".clearing-close", touch_label: "&larr;&nbsp;Swipe to Advance&nbsp;&rarr;", init: !1, locked: !1}, init: function (t, e, i) {
        ...
        t(".scroll-container").length > 0 && (this.scope = t(".scroll-container")), a(this.scope).off(".clearing").on("click.fndtn.clearing", "ul[" + this.attr_name() + "] li",function (t, e, i) {
            var e = e || a(this), i = i || e, n = e.next("li"), o = e.closest("[" + s.attr_name() + "]").data(s.attr_name(!0) + "-init"), r = a(t.target);
        ...
        function o(e) {
            var i = t(e);
            e.css("visibility", "visible"), l.css("overflow", "hidden"), c.addClass("clearing-blackout"), d.addClass("clearing-container"), u.show(), this.fix_height(s).caption(r.S(".clearing-caption", u), i).center_and_label(e, p).shift(n, s, function () {
                s.siblings().removeClass("visible"), s.addClass("visible")
            })
        }

        var r = this, l = t(i.body), c = s.closest(".clearing-assembled"), d = t("div", c).first(), u = t(".visible-img", d), h = t("img", u).not(e), p = t(".clearing-touch-label", ".clearing-blackout"), f = !1;
        h.error(function () {
            f = !0
        ...
        return n === e.target && o && (r.css("overflow", ""), s = t("div", o).first(), a = t(".visible-img", s), this.settings.prev_index = 0, t("ul[" + this.attr_name() + "]", o).attr("style", "").closest(".clearing-blackout").removeClass("clearing-blackout"), s.removeClass("clearing-container"), a.hide()), !1
    }, is_open: function (t) {
        return t.parent().prop("style").length > 0
    }, keydown: function (e) {
        var i = t(".clearing-blackout ul[" + this.attr_name() + "]"), n = this.rtl ? 37 : 39, s = this.rtl ? 39 : 37, a = 27;
    ...
    Foundation.libs.dropdown = {name: "dropdown", version: "5.2.0", settings: {active_class: "open", align: "bottom", is_hover: !1, opened: function () {
        ...
        if (this.clear_idx(), this.small()) {
            ...
            var n = e.data(this.attr_name(!0) + "-init") || this.settings;
            this.style(t, e, n)
        }
        return t
        ...
        var e = this.offsetParent(), i = e.offset(), n = t.offset();
        return n.top -= i.top, n.left -= i.left, n
    }, top: function (t) {
        var e = Foundation.libs.dropdown, i = e.dirs._base.call(this, t), n = t.outerWidth() / 2 - 8;
        return this.addClass("drop-top"), (t.outerWidth() < this.outerWidth() || e.small()) && e.adjust_pip(n, i), Foundation.rtl ? {left: i.left - this.outerWidth() + t.outerWidth(), top: i.top - this.outerHeight()} : {left: i.left, top: i.top - this.outerHeight()}
    }, bottom: function (t) {
        var e = Foundation.libs.dropdown, i = e.dirs._base.call(this, t), n = t.outerWidth() / 2 - 8;
        return(t.outerWidth() < this.outerWidth() || e.small()) && e.adjust_pip(n, i), e.rtl ? {left: i.left - this.outerWidth() + t.outerWidth(), top: i.top + t.outerHeight()} : {left: i.left, top: i.top + t.outerHeight()}
    }, left: function (t) {
        ...
        var n = ".f-dropdown.open:before", s = ".f-dropdown.open:after", a = "left: " + t + "px;", o = "left: " + (t - 1) + "px;";
    ...
    Foundation.libs.interchange = {name: "interchange", version: "5.2.0", cache: {}, images_loaded: !1, nodes_loaded: !1, settings: {load_attr: "interchange", named_queries: {"default": Foundation.media_queries.small, small: Foundation.media_queries.small, medium: Foundation.media_queries.medium, large: Foundation.media_queries.large, xlarge: Foundation.media_queries.xlarge, xxlarge: Foundation.media_queries.xxlarge, landscape: "only screen and (orientation: landscape)", portrait: "only screen and (orientation: portrait)", retina: "only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and (min-resolution: 192dpi),only screen and (min-resolution: 2dppx)"}, directives: {replace: function (e, i, n) {
        ...
        if (a != i) {
            ...
            return new RegExp(o, "i").test(i) ? (t(e).css("background-image", "url(" + i + ")"), e.data("interchange-last-path", i), n(i)) : t.get(i, function (t) {
    ...
    }, template: {link: '<a href="#close" class="joyride-close-tip">&times;</a>', timer: '<div class="joyride-timer-indicator-wrap"><span class="joyride-timer-indicator"></span></div>', tip: '<div class="joyride-tip-guide"><span class="joyride-nub"></span></div>', wrapper: '<div class="joyride-content-wrapper"></div>', button: '<a href="#" class="small button joyride-next-tip"></a>', modal: '<div class="joyride-modal-bg"></div>', expose: '<div class="joyride-expose-wrapper"></div>', expose_cover: '<div class="joyride-expose-cover"></div>'}, expose_add_class: ""}, init: function (e, i, n) {
    ...
    Foundation.libs.offcanvas = {name: "offcanvas", version: "5.2.0", settings: {}, init: function () {
        ...
        }).on("click.fndtn.offcanvas", ".left-off-canvas-menu a",function (n) {
            n.preventDefault();
            var s = t(this).attr("href");
            i(".off-canvas-wrap").on("transitionend webkitTransitionEnd oTransitionEnd", function () {
                e.location = s, i(".off-canvas-wrap").off("transitionend webkitTransitionEnd oTransitionEnd")
    ...
    var n = function () {
        ...
        var r, l, c, d, u, h = this, p = n, f = 0;
        h.cache = {}, h.slides = function () {
            return p.children(s.slide_selector)
        }, h.slides().first().addClass(s.active_slide_class), h.update_slide_number = function (e) {
            ...
            var i = h.slides();
            h.cache.animating = !0;
            var n = h._prepare_direction(t), a = n[0], o = n[1], r = n[2], t = n[3];
            p.trigger("before-slide-change.fndtn.orbit"), s.before_slide_change(), f = t, o.css("transitionDuration", s.animation_speed + "ms"), r.css("transitionDuration", s.animation_speed + "ms");
            var l = function () {
                var n = function () {
                    e === !0 && h.cache.timer.restart(), h.update_slide_number(f), r.addClass(s.active_slide_class), h.update_active_link(t), p.trigger("after-slide-change.fndtn.orbit", [
                        {slide_number: f, total_slides: i.length}
                    ]), s.after_slide_change(f, i.length), setTimeout(function () {
                        h.cache.animating = !1
                    }, 100)
                };
                p.height() != r.height() && s.variable_height ? p.animate({height: r.height()}, 250, "linear", n) : n()
            };
            if (1 === i.length)return l(), !1;
            var c = function () {
                "next" === a && u.next(o, r, l), "prev" === a && u.prev(o, r, l)
            };
            r.height() > p.height() && s.variable_height ? p.animate({height: r.height()}, 250, "linear", c) : c()
        }, h.next = function (t) {
            t.stopImmediatePropagation(), t.preventDefault(), h._prepare_direction(f + 1), setTimeout(function () {
                h._goto(f + 1)
            }, 100)
        }, h.prev = function (t) {
            t.stopImmediatePropagation(), t.preventDefault(), h._prepare_direction(f - 1), setTimeout(function () {
            ...
            if ("string" == typeof i && "" != (i = t.trim(i))) {
                var n = r.find("[data-orbit-slide=" + i + "]");
                -1 != n.index() && setTimeout(function () {
                    h._goto(n.index())
                }, 100)
            }
        }, h.link_bullet = function () {
            ...
            h.build_markup(), s.timer && (h.cache.timer = h.create_timer(), Foundation.utils.image_loaded(this.slides().children("img"), h.cache.timer.start)), "fade" === s.animation && p.addClass("fade"), u = new o(s, p), r.on("click", "." + s.next_class, h.next), r.on("click", "." + s.prev_class, h.prev), r.on("click", "[data-orbit-slide]", h.link_bullet), r.on("click", h.toggle_timer), s.swipe && p.on("touchstart.fndtn.orbit",function (t) {
                t.preventDefault(), t.stopPropagation(), h.cache.animating || (t.touches || (t = t.originalEvent), h.cache.start_page_x = t.touches[0].pageX, h.cache.start_page_y = t.touches[0].pageY, h.cache.start_time = (new Date).getTime(), h.cache.delta_x = 0, h.cache.is_scrolling = null, h.cache.direction = null, h.stop_timer())
            }).on("touchmove.fndtn.orbit",function (t) {
                h.cache.animating || (t.preventDefault(), t.stopPropagation(), requestAnimationFrame(function () {
                    if (t.touches || (t = t.originalEvent), !(t.touches.length > 1 || t.scale && 1 !== t.scale || (h.cache.delta_x = t.touches[0].pageX - h.cache.start_page_x, null === h.cache.is_scrolling && (h.cache.is_scrolling = !!(h.cache.is_scrolling || Math.abs(h.cache.delta_x) < Math.abs(t.touches[0].pageY - h.cache.start_page_y))), h.cache.is_scrolling))) {
                        var e = h.cache.delta_x < 0 ? f + 1 : f - 1;
                        if (h.cache.direction !== e) {
                            var i = h._prepare_direction(e);
                            h.cache.direction = e, h.cache.dir = i[0], h.cache.current = i[1], h.cache.next = i[2]
                        }
                        if ("slide" === s.animation) {
                            var n, a;
                            n = h.cache.delta_x / r.width() * 100, a = n >= 0 ? -(100 - n) : 100 + n, h.cache.current.css("transform", "translate3d(" + n + "%,0,0)"), h.cache.next.css("transform", "translate3d(" + a + "%,0,0)")
                        }
                    }
                }))
            ...
            }), t(i).on("click", "[data-orbit-link]", h.link_custom), t(e).on("resize", h.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), h.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), function () {
                r.prev(".preloader").css("display", "none"), h.update_slide_number(0), h.update_active_link(0), p.trigger("ready.fndtn.orbit")
            })
        }, h.init()
    }, a = function (t, e, i) {
        ...
        this.next = function (t, n, s) {
            n.on(i, function () {
                n.unbind(i), t.removeClass("active animate-out"), n.removeClass("animate-in"), s()
            }), e.children().css({transform: "", transitionDuration: ""}), t.addClass("animate-out"), n.addClass("animate-in")
        }, this.prev = function (t, e, n) {
            e.on(i, function () {
                e.unbind(i), t.removeClass("active animate-out"), e.removeClass("animate-in"), n()
    ...
    Foundation.libs.reveal = {name: "reveal", version: "5.2.0", locked: !1, settings: {animation: "fadeAndPop", animation_speed: 250, close_on_background_click: !0, close_on_esc: !0, dismiss_modal_class: "close-reveal-modal", bg_class: "reveal-modal-bg", open: function () {
        ...
        if (!s.hasClass("open")) {
            ...
            if ("undefined" == typeof s.data("css-top") && s.data("css-top", parseInt(s.css("top"), 10)).data("offset", this.cache_offset(s)), this.key_up_on(s), s.trigger("open"), o.length < 1 && this.toggle_bg(s), "string" == typeof i && (i = {url: i}), "undefined" != typeof i && i.url) {
                ...
                t.extend(i, {success: function (e, i, l) {
                    t.isFunction(r) && r(e, i, l), s.html(e), n.S(s).foundation("section", "reflow"), o.length > 0 && n.hide(o, a.css.close), n.show(s, a.css.open)
                }}), t.ajax(i)
        ...
        if (n) {
            var a = i.data(this.attr_name(!0) + "-init"), o = s(a.animation);
    ...
    Foundation.libs.tab = {name: "tab", version: "5.2.0", settings: {active_class: "active", callback: function () {
        ...
        var n = this, s = this.S;
        this.bindings(e, i), this.handle_location_hash_change(), s("[" + this.attr_name() + "] > dd.active > a", this.scope).each(function () {
            ...
            if (s.deep_linking) {
                ...
                if ("" != a) {
                    ...
                    if (o.hasClass("content") && o.parent().hasClass("tab-content"))e.toggle_active_tab(t("[" + e.attr_name() + "] > dd > a[href=" + a + "]").parent()); else {
                        ...
                        r != n && e.toggle_active_tab(t("[" + e.attr_name() + "] > dd > a[href=#" + r + "]").parent(), a)
                    }
        ...
        var a = this.S, o = i.closest("[" + this.attr_name() + "]"), r = i.children("a").first(), l = "#" + r.attr("href").split("#")[1], c = a(l), d = i.siblings(), u = o.data(this.attr_name(!0) + "-init");
        ...
        i.addClass(u.active_class).triggerHandler("opened"), d.removeClass(u.active_class), c.siblings().removeClass(u.active_class).end().addClass(u.active_class), u.callback(i), o.triggerHandler("toggled", [i])
    }, data_attr: function (t) {
        return this.namespace.length > 0 ? this.namespace + "-" + t : t
    }, off: function () {
    }, reflow: function () {
    ...
    Foundation.libs.tooltip = {name: "tooltip", version: "5.2.0", settings: {additional_inheritable_classes: [], tooltip_class: ".tooltip", append_to: "body", touch_close_text: "Tap To Close", disable_for_touch: !1, hover_delay: 200, tip_template: function (t, e) {
        ...
        i.create(this.S(e)), t(this.scope).off(".tooltip").on("mouseenter.fndtn.tooltip mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip", "[" + this.attr_name() + "]:not(a)",function (e) {
            var s = n(this), a = t.extend({}, i.settings, i.data_options(s)), o = !1;
        ...
        var n = this, s = t.extend({}, this.settings, this.data_options(i)), a = this.settings.tip_template;
        ...
        var s, a, o, r, l;
        if (i.css("visibility", "hidden").show(), s = e.data("width"), a = i.children(".nub"), o = a.outerHeight(), r = a.outerHeight(), this.small() ? i.css({width: "100%"}) : i.css({width: s ? s : "auto"}), l = function (t, e, i, n, s) {
        ...
        var i = t.extend({}, this.settings, this.data_options(e)), n = ["tip-top", "tip-left", "tip-bottom", "tip-right", "radius", "round"].concat(i.additional_inheritable_classes), s = e.attr("class"), a = s ? t.map(s.split(" "),function (e) {
    ...
    "use strict";
    Foundation.libs.topbar = {name: "topbar", version: "5.2.0", settings: {index: 0, sticky_class: "sticky", custom_back_text: !0, back_text: "Back", is_hover: !0, mobile_show_parent_link: !1, scrolltop: !0, sticky_on: "all"}, init: function (e, i, n) {
        ...
        return n && "all" === i.sticky_on ? !0 : n && this.small() && "small" === i.sticky_on ? !0 : n && this.medium() && "medium" === i.sticky_on ? !0 : n && this.large() && "large" === i.sticky_on ? !0 : !1
    }, toggle: function (i) {
        var n = this;
        ...
        n(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar",function (t) {
            ...
            var e = n(this), s = n(t.target), a = e.closest("[" + i.attr_name() + "]"), o = a.data(i.attr_name(!0) + "-init");
            return s.data("revealId") ? (i.toggle(), void 0) : (i.breakpoint() || (!o.is_hover || Modernizr.touch) && (t.stopImmediatePropagation(), e.hasClass("hover") ? (e.removeClass("hover").find("li").removeClass("hover"), e.parents("li.hover").removeClass("hover")) : (e.addClass("hover"), "A" === s[0].nodeName && s.parent().hasClass("has-dropdown") && t.preventDefault())), void 0)
        }).on("click.fndtn.topbar", "[" + this.attr_name() + "] .has-dropdown>a", function (t) {
            if (i.breakpoint()) {
                t.preventDefault();
                var e = n(this), s = e.closest("[" + i.attr_name() + "]"), a = s.find("section, .section"), o = (e.next(".dropdown").outerHeight(), e.closest("li"));
                s.data("index", s.data("index") + 1), o.addClass("moved"), i.rtl ? (a.css({right: -(100 * s.data("index")) + "%"}), a.find(">.name").css({right: 100 * s.data("index") + "%"})) : (a.css({left: -(100 * s.data("index")) + "%"}), a.find(">.name").css({left: 100 * s.data("index") + "%"})), s.css("height", e.siblings("ul").outerHeight(!0) + s.data("height"))
            }
            ...
            e.length > 0 || n("[" + i.attr_name() + "] li").removeClass("hover")
        }), n(this.scope).on("click.fndtn.topbar", "[" + this.attr_name() + "] .has-dropdown .back", function (t) {
            t.preventDefault();
            var e = n(this), s = e.closest("[" + i.attr_name() + "]"), a = s.find("section, .section"), o = (s.data(i.attr_name(!0) + "-init"), e.closest("li.moved")), r = o.parent();
            s.data("index", s.data("index") - 1), i.rtl ? (a.css({right: -(100 * s.data("index")) + "%"}), a.find(">.name").css({right: 100 * s.data("index") + "%"})) : (a.css({left: -(100 * s.data("index")) + "%"}), a.find(">.name").css({left: 100 * s.data("index") + "%"})), 0 === s.data("index") ? s.css("height", "") : s.css("height", r.outerHeight(!0) + s.data("height")), setTimeout(function () {
                o.removeClass("moved")
            }, 300)
        })
    }, resize: function () {
        ...
        t.S("[" + this.attr_name() + "]").each(function () {
            var e, n = t.S(this), s = n.data(t.attr_name(!0) + "-init"), a = n.parent("." + t.settings.sticky_class);
            if (!t.breakpoint()) {
    ...
    i.extend(r, {version: "2.1.5", defaults: {padding: 15, margin: 20, width: 800, height: 600, minWidth: 100, minHeight: 100, maxWidth: 9999, maxHeight: 9999, pixelRatio: 1, autoSize: !0, autoHeight: !1, autoWidth: !1, autoResize: !0, autoCenter: !d, fitToView: !0, aspectRatio: !1, topRatio: .5, leftRatio: .5, scrolling: "auto", wrapCSS: "", arrows: !0, closeBtn: !0, closeClick: !1, nextClick: !1, mouseWheel: !0, autoPlay: !1, playSpeed: 3e3, preload: 3, modal: !1, loop: !0, ajax: {dataType: "html", headers: {"X-fancyBox": !0}}, iframe: {scrolling: "auto", preload: !0}, swf: {wmode: "transparent", allowfullscreen: "true", allowscriptaccess: "always"}, keys: {next: {13: "left", 34: "up", 39: "left", 40: "up"}, prev: {8: "right", 33: "down", 37: "right", 38: "down"}, close: [27], play: [32], toggle: [70]}, direction: {next: "left", prev: "right"}, scrollOutside: !0, index: 0, type: null, href: null, content: null, title: null, tpl: {wrap: '<div class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div class="fancybox-outer"><div class="fancybox-inner"></div></div></div></div>', image: '<img class="fancybox-image" src="{href}" alt="" />', iframe: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' + (l ? ' allowtransparency="true"' : "") + "></iframe>", error: '<p class="fancybox-error">The requested content cannot be loaded.<br/>Please reload page.</p>', closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a>', next: '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>', prev: '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'}, openEffect: "fade", openSpeed: 250, openEasing: "swing", openOpacity: !0, openMethod: "zoomIn", closeEffect: "fade", closeSpeed: 250, closeEasing: "swing", closeOpacity: !0, closeMethod: "zoomOut", nextEffect: "elastic", nextSpeed: 250, nextEasing: "swing", nextMethod: "changeIn", prevEffect: "elastic", prevSpeed: 250, prevEasing: "swing", prevMethod: "changeOut", helpers: {overlay: !0, title: !0}, onCancel: i.noop, beforeLoad: i.noop, afterLoad: i.noop, beforeShow: i.noop, afterShow: i.noop, beforeChange: i.noop, beforeClose: i.noop, afterClose: i.noop}, group: {}, opts: {}, previous: null, coming: null, current: null, isActive: !1, isOpen: !1, isOpened: !1, wrap: null, skin: null, outer: null, inner: null, player: {timer: null, isActive: !1}, ajaxLoad: null, imgPreload: null, transitions: {}, helpers: {}, open: function (t, e) {
        return t && (i.isPlainObject(e) || (e = {}), !1 !== r.close(!0)) ? (i.isArray(t) || (t = u(t) ? i(t).get() : [t]), i.each(t, function (s, a) {
            var o, l, c, d, p, f = {};
    ...
    function e(e) {
        var i = e || window.event, n = [].slice.call(arguments, 1), s = 0, a = 0, o = 0, e = t.event.fix(i);
        return e.type = "mousewheel", i.wheelDelta && (s = i.wheelDelta / 120), i.detail && (s = -i.detail / 3), o = s, void 0 !== i.axis && i.axis === i.HORIZONTAL_AXIS && (o = 0, a = -1 * s), void 0 !== i.wheelDeltaY && (o = i.wheelDeltaY / 120), void 0 !== i.wheelDeltaX && (a = -1 * i.wheelDeltaX / 120), n.unshift(e, s, a, o), (t.event.dispatch || t.event.handle).apply(this, n)
    }

    var i = ["DOMMouseScroll", "mousewheel"];
    if (t.event.fixHooks)for (var n = i.length; n;)t.event.fixHooks[i[--n]] = t.event.mouseHooks;
    t.event.special.mousewheel = {setup: function () {
...
}.call(this), $(document).foundation(), function (t) {
    var e = t.fancybox;
    e.helpers.buttons = {defaults: {skipSingle: !1, position: "top", tpl: '<div id="fancybox-buttons"><ul><li><a class="btnPlay" title="Start slideshow" href="javascript:;"></a></li><li><a class="btnToggle" title="Toggle size" href="javascript:;"></a></li></ul></div>'}, list: null, buttons: null, beforeLoad: function (t, e) {
        return t.skipSingle && e.group.length < 2 ? (e.helpers.buttons = !1, e.closeBtn = !0, void 0) : (e.margin["bottom" === t.position ? 2 : 0] += 30, void 0)
    }, onPlayStart: function () {
        this.buttons && this.buttons.play.attr("title", "Pause slideshow").addClass("btnPlayOn")
    }, onPlayEnd: function () {
    ...
    $(".fancybox").fancybox({openEffect: "elastic", closeBtn: !0, helpers: {title: {type: "inside"}, buttons: {}, mouseWheel: !0, thumbs: {width: 75, height: 50}, overlay: {css: {background: "rgba(0,  139 ,139, 0.95)"}}}, afterLoad: function () {
    ...
    $("remove_button").click(function () {
        ...
        var t = $(this).find("img");
        $(this).scrollTop((t.height() - $(this).height()) / 2), $(this).scrollLeft((t.width() - $(this).width()) / 2)
    })
